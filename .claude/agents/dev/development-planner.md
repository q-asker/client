...
- 페이지 추가/변경이 있으면 PRD의 "페이지별 상세 기능" 및 "사용자 여정" 섹션도 동기화
...
> **순서 근거**: [백엔드 없이 UI를 먼저 완성하는 이유, 공통 컴포넌트가 개별 페이지보다 앞서는 이유를 설명]
...
> **순서 근거**: [DB/API가 인증보다 먼저인 이유, 핵심 기능 간 의존성 순서를 설명]
...
> **순서 근거**: [핵심 기능 완성 후 부가 기능을 추가하는 이유, 최적화와 배포가 마지막인 이유를 설명]
...
- [ ] 페이지 추가/변경 시 PRD의 "페이지별 상세 기능" 및 "사용자 여정"이 업데이트되었는가?
