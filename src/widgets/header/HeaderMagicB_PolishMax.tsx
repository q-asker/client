  ...
  return (
    <div className="relative bg-background">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-4 py-3 md:px-6">
        ...
        {/* 네비게이션 + BlurFade stagger 입장 + glow 인디케이터 */}
        <div className="flex items-center gap-2">
          <nav className="relative flex items-center gap-1">
            {navItems.map((item, index) => {
              ...
              return (
                <BlurFade key={item.path} delay={index * 0.05}>
                  <div className="relative inline-flex flex-col items-center">
                    <Link
                      to={item.path}
                      className={cn(
                        'inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium no-underline transition-colors duration-200',
                    ...
                    {active && (
                      <motion.div
                        layoutId="header-nav-indicator-px"
                        className="absolute bottom-0 left-3 right-3 h-0.5 rounded-full bg-primary shadow-[0_2px_8px] shadow-primary/30"
          ...
          <>
            ...
            >
              ...
              <nav className="flex flex-col gap-0 p-2">
                {/* 언어 선택 — 좌측 accent 바 */}
                <motion.div
                  className="flex cursor-pointer items-center justify-between rounded-lg border-l-2 border-transparent px-4 py-3.5 text-sm text-muted-foreground transition-colors duration-200 hover:border-primary hover:bg-primary/5 hover:text-foreground"
                  custom={0}
                ...
                {/* 도움말 — 좌측 accent 바 */}
                <motion.button
                  className="flex w-full cursor-pointer items-center gap-3 rounded-lg border-l-2 border-transparent border-none bg-transparent px-4 py-3.5 text-left text-xs font-bold uppercase tracking-[0.15em] text-muted-foreground transition-colors duration-200 hover:border-primary hover:bg-primary/5 hover:text-foreground"
                  type="button"
                  custom={1}
                  variants={sidebarItemVariants}
                  initial="hidden"
...
export default HeaderMagicB_PolishMax;
