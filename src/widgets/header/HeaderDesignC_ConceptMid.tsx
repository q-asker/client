    ...
    <div className="relative bg-background">
      <div className="border-b border-border">
        <div className="mx-auto flex h-10 w-full max-w-5xl items-center justify-between px-3 md:px-5">
          ...
          {/* 우측: 그룹핑된 아이콘 — 네비 그룹 | 구분자 | 인증 그룹 */}
          <div className="flex items-center">
            {/* 네비 그룹 */}
            <div className="flex items-center gap-0.5 rounded-md bg-muted/40 px-1 py-0.5">
              <Link
                to="/boards"
                className={cn(
                  'group relative flex size-7 items-center justify-center rounded-sm no-underline transition-colors duration-150',
                  isActive('/boards')
          ...
          <>
            ...
            >
              ...
              <nav className="flex flex-col px-2 py-2">
                <span className="mb-1 px-3 text-[8px] font-bold uppercase tracking-[0.25em] text-muted-foreground/60">
                  {t('설정')}
                </span>
                ...
                <span className="mb-1 mt-2 px-3 text-[8px] font-bold uppercase tracking-[0.25em] text-muted-foreground/60">
                  {t('지원')}
                </span>
