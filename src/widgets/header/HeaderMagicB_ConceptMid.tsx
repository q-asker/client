              ...
              return (
                <BlurFade key={item.path} delay={item.delay}>
                  <div className="relative inline-flex flex-col items-center">
                    ...
                    {active && (
                      <motion.div
                        layoutId="header-nav-indicator-cm"
...
export default HeaderMagicB_ConceptMid;
