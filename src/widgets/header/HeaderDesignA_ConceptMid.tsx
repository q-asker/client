...
const HeaderDesignA_ConceptMid = ({
  isSidebarOpen,
  toggleSidebar,
  setIsSidebarOpen,
  setShowHelp,
  ...
  return (
    <div className="relative bg-background border-b border-border">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-4 py-3 md:px-6">
        ...
        {/* 타이포그래피 기반 네비게이션 — 세로 구분자 + animated 밑줄 */}
          ...
          <nav className="flex items-center gap-5">
            <BlurFade delay={0.05}>
              <Link
                to="/boards"
                className={cn(
                  'group relative inline-flex items-center gap-1.5 pb-1 text-sm font-medium uppercase tracking-wide no-underline transition-colors duration-200',
                  isActive('/boards')
              ...
              >
                {/* 아이콘 크기 size-5 */}
                <MessageSquare className="size-5 sm:hidden" />
            ...
            <BlurFade delay={0.1}>
              <div className="relative inline-flex items-center">
                ...
                >
                  <ClipboardList className="size-5 sm:hidden" />
        ...
        {isSidebarOpen && (
          <>
            ...
            >
              ...
              {/* 사이드바 네비게이션 — 메뉴 영역 (현재 메뉴 아이템 없음, 확장 가능) */}
...
export default HeaderDesignA_ConceptMid;
