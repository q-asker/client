...
const HeaderDesignA_PolishMax = ({
  ...
  return (
    <div className="relative bg-background border-b border-border">
          ...
          <nav className="flex items-center gap-3">
            <BlurFade delay={0.05}>
              <Link
                to="/boards"
                className={cn(
                  'inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium uppercase tracking-wide no-underline transition-colors duration-200 hover:bg-muted/50',
                  isActive('/boards')
      ...
      {/* 사이드바 + 오버레이 — 카드형 메뉴 아이템 + bg-muted/20 배경 */}
      <AnimatePresence>
        {isSidebarOpen && (
          <>
            <motion.div
            ...
            >
              ...
              {/* 사이드바 네비게이션 — 카드형 메뉴 아이템 */}
              <nav className="flex flex-col gap-2 bg-muted/20 px-3 py-3">
                <motion.div
                  className="flex cursor-pointer items-center justify-between rounded-lg bg-muted/50 p-3 shadow-sm text-muted-foreground transition-colors duration-200 hover:text-foreground"
                  custom={0}
                ...
                >
                  ...
                  <div className="flex gap-1">
                    <button
                      className="cursor-pointer border-none bg-transparent px-2 py-1 text-[11px] font-bold text-muted-foreground transition-colors duration-200 hover:text-foreground"
                ...
                <motion.button
                  className="flex w-full cursor-pointer items-center gap-3 rounded-lg border-none bg-muted/50 p-3 shadow-sm text-left text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground transition-colors duration-200 hover:text-foreground"
                  type="button"
                  custom={1}
                  variants={sidebarItemVariants}
                  initial="hidden"
...
export default HeaderDesignA_PolishMax;
