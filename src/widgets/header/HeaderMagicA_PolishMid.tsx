...
const HeaderMagicA_PolishMid = ({
  ...
  return (
    // 미세 조정: backdrop-blur-lg, border-border/40
    <div className="relative border-b border-border/40 bg-background/80 backdrop-blur-lg">
        ...
        <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive('/boards')
                    ...
                    : 'border-border/40 bg-background/60 text-muted-foreground backdrop-blur-sm hover:bg-muted hover:text-foreground',
                )}
              >
          ...
          {isAuthenticated && (
            <div className="relative">
              <button
                id="profileButton"
                className="inline-flex size-8 cursor-pointer items-center justify-center rounded-full border border-border/40 bg-primary/10 p-0 text-sm font-bold text-primary backdrop-blur-sm transition-colors duration-200 hover:bg-primary/20 md:size-9 md:text-base"
              ...
              <AnimatePresence>
                {isProfileOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-[calc(100%+8px)] z-[1001] min-w-[180px] rounded-xl border border-border/40 bg-background/90 p-3 shadow-xl backdrop-blur-xl"
                  >
                    <motion.span
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 z-[1000] flex h-full w-[280px] flex-col border-r border-border/40 bg-background/95 backdrop-blur-xl"
            >
              ...
              <nav className="flex flex-col gap-0 p-2">
                <motion.div
                  className="flex cursor-pointer items-center justify-between px-4 py-2.5 text-sm text-muted-foreground transition-colors duration-200 hover:text-foreground"
                  custom={0}
                ...
                <motion.button
                  className="flex w-full cursor-pointer items-center gap-3 border-none bg-transparent px-4 py-2.5 text-left text-xs font-bold uppercase tracking-[0.15em] text-muted-foreground transition-colors duration-200 hover:text-foreground"
                  type="button"
                  custom={1}
                  variants={sidebarItemVariants}
                  initial="hidden"
...
export default HeaderMagicA_PolishMid;
