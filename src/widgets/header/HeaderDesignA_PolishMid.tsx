  ...
  return (
    <div className="relative bg-background border-b border-border">
      <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-4 py-3 md:px-6">
        ...
        {/* 타이포그래피 기반 네비게이션 — hover 시 밑줄 색상 전환, 아이콘 hover:scale-110 */}
          ...
          <nav className="flex items-center gap-5">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive('/boards')
                    ...
                    : 'border-b-2 border-muted-foreground/30 text-muted-foreground hover:border-primary hover:text-foreground',
                )}
              >
                {/* 모바일: 아이콘만 / 데스크톱: 텍스트만 */}
                <MessageSquare className="size-4 transition-transform duration-200 hover:scale-110 sm:hidden" />
            ...
            <BlurFade delay={0.16}>
              <div className="relative inline-flex items-center">
                ...
                >
                  <ClipboardList className="size-4 transition-transform duration-200 hover:scale-110 sm:hidden" />
            ...
            {!isAuthenticated && (
              <BlurFade delay={0.24}>
                <Link
                  ...
                  to="/login"
                >
                  <LogIn className="size-4 transition-transform duration-200 hover:scale-110 sm:hidden" />
        ...
        {isSidebarOpen && (
          <>
            ...
            >
              ...
              {/* 사이드바 네비게이션 — hover 시 좌측 border slide-in */}
              <nav className="flex flex-col gap-0 px-3 py-2">
                <motion.div
                  className="flex cursor-pointer items-center justify-between border-l-2 border-transparent px-4 py-3 text-muted-foreground transition-all duration-200 hover:border-l-2 hover:border-primary hover:text-foreground"
                  custom={0}
                ...
                >
                  <span className="flex items-center gap-3 text-[11px] font-bold uppercase tracking-[0.15em]">
                    <Globe className="size-3.5 transition-transform duration-200 hover:scale-110" />
                    {t('언어')}
                  </span>
                ...
                <motion.button
                  className="flex w-full cursor-pointer items-center gap-3 border-l-2 border-transparent border-y-0 border-r-0 border-solid bg-transparent px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.15em] text-muted-foreground transition-all duration-200 hover:border-primary hover:text-foreground"
                  type="button"
                  custom={1}
                  variants={sidebarItemVariants}
                  initial="hidden"
                  ...
                  onClick={handleHelp}
                >
                  <HelpCircle className="size-3.5 transition-transform duration-200 hover:scale-110" />
                  {t('도움말 보기')}
                </motion.button>
              </nav>
            </motion.aside>
...
export default HeaderDesignA_PolishMid;
