...
/** Minimal Form — 최소 장식, 큰 타이포, 넓은 입력 영역 */
const BoardWriteDesignB = () => {
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        <div className="mx-auto max-w-4xl px-6 py-10 max-md:px-4">
          {/* 큰 제목 */}
          <h1 className="mb-8 text-4xl font-bold text-foreground max-md:text-2xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            {/* 하단 고정 액션 바 */}
            <div className="sticky bottom-0 -mx-6 border-t border-border bg-background/95 px-6 py-4 backdrop-blur max-md:-mx-4 max-md:px-4">
...
export default BoardWriteDesignB;
