    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-[95%] max-w-[1200px] flex-col py-6 lg:grid lg:grid-cols-12 lg:gap-6">
        ...
        <section className="flex flex-col gap-4 lg:col-span-8">
            ...
            <>
              ...
              <div className="flex w-full items-center rounded-2xl bg-card p-5 shadow-card max-md:flex-col max-md:items-start max-md:gap-3">
                ...
                <div className="border-l border-border pl-4 max-md:self-end max-md:border-l-0 max-md:pl-0">
                  <label className="flex cursor-pointer select-none items-center whitespace-nowrap text-sm font-bold text-muted-foreground transition-colors duration-200 hover:text-primary">
                    <input
                      type="checkbox"
          ...
          {/* 제출하기 버튼 */}
          <button
            className="mt-6 w-[120px] cursor-pointer self-end rounded-2xl border-none bg-primary py-3 text-sm font-medium text-primary-foreground transition-colors duration-200 hover:opacity-90 max-md:mt-4 max-md:w-full max-md:self-stretch"
