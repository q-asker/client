...
/** Slide Panel — DesignB + BlurFade 패널/본문 stagger */
        ...
        <div className="mx-auto max-w-5xl px-6 py-8 max-md:px-4">
          <div className="grid gap-6 lg:grid-cols-[1fr_280px]">
            ...
            <div>
              ...
              <BlurFade delay={0.1}>
                <div className="mb-8 min-h-[200px] whitespace-pre-wrap border-l-2 border-primary/10 pl-4 leading-relaxed text-foreground">
                  {post.content}
                </div>
              </BlurFade>
              ...
              {post.replies && post.replies.length > 0 ? (
                <div className="flex flex-col gap-2">
                  {post.replies.map((reply, index) => (
                    <BlurFade key={index} delay={0.25 + 0.06 * index}>
                      <div className="rounded-lg border border-border bg-gradient-to-r from-muted/40 to-transparent px-4 py-3">
