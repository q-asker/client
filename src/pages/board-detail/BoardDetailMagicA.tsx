...
/** Smooth Article — DesignA + BlurFade 섹션별 stagger */
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        <div className="mx-auto max-w-3xl px-6 py-8 max-md:px-4">
          {/* 게시글 카드 */}
          <BlurFade delay={0.05}>
            <Card className="mb-6 border-t-4 border-t-primary/30 shadow-lg shadow-primary/5">
              <CardHeader>
                ...
                <CardTitle className="text-2xl leading-tight max-md:text-xl">
                  {post.title}
                </CardTitle>
          ...
          {post.replies && post.replies.length > 0 ? (
            <div className="mb-8 flex flex-col gap-3">
              {post.replies.map((reply, index) => (
                <BlurFade key={index} delay={0.2 + 0.08 * index}>
