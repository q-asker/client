...
/** Clean Reader — 에디토리얼 톤, Shadcn Card로 해설/선택지 래핑 */
const QuizExplanationDesignA: React.FC = () => {
            ...
            {explanation.thisExplanationObj?.referencedPages &&
              explanation.thisExplanationObj.referencedPages.length > 0 && (
                <div className="mt-6 rounded-lg bg-muted p-4">
                  <h4 className="mb-3 text-sm font-semibold text-foreground">{t('참조 페이지')}</h4>
...
export default QuizExplanationDesignA;
