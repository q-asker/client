...
/**
 * Navigator Split — 34번(Split Flow) + 좌측 문제 리스트 사이드바.
 * [문제 리스트 | 문제+선택지 | 해설+참조] 3열 레이아웃.
 * 사이드바: 진행률 바 + 정답 통계 + 문제 목록(번호+제목).
 */
const QuizExplanationDesignR: React.FC = () => {
...
export default QuizExplanationDesignR;
