...
/** Card Flip — DesignB 기반 + BlurFade stagger */
const QuizExplanationMagicB: React.FC = () => {
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 gap-6 px-6 py-8 max-lg:flex-col max-md:px-4 max-md:py-6">
        ...
        <div className="flex flex-1 flex-col gap-6">
          ...
          {/* 참조 페이지 + PDF 카드 */}
          <BlurFade key={`pdf-${quiz.currentQuestion}`} delay={0.25}>
            <Card>
              <CardHeader>
...
export default QuizExplanationMagicB;
