...
/** Slide Transition — 좌우 분할 + BlurFade 전환 애니메이션 */
const QuizExplanationMagicE: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 gap-6 px-6 py-6 max-lg:flex-col max-md:px-4">
        {/* 좌측 — BlurFade 진입 */}
        <BlurFade delay={0.1} className="flex flex-1 flex-col gap-4">
          ...
          <div className="rounded-xl bg-card p-5 shadow-sm">
            <p className="mb-3 whitespace-pre-wrap text-base font-semibold leading-relaxed">
            ...
            {quiz.currentQuiz.selections.map((opt, idx) => {
              ...
              const wrongSel =
                ...
                !correct;
              return (
                <BlurFade key={opt.id} delay={0.1 + idx * 0.05}>
                  <div
                    className={cn(
                      'mb-1.5 flex items-center rounded-lg px-4 py-2.5 text-sm',
                      correct
                  ...
                  >
                    <span className="mr-3 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-muted text-xs font-medium">
                      {idx + 1}
                    </span>
        ...
        {/* 우측 — BlurFade 진입 */}
        <BlurFade delay={0.2} className="flex flex-1 flex-col gap-4">
          <div className="rounded-xl bg-card p-5 shadow-sm">
...
export default QuizExplanationMagicE;
