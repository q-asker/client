      ...
      <div className="mx-auto mt-8 flex-1 px-4 md:mt-6 md:w-[90%] lg:w-[70%]">
        ...
        <div className="relative ml-6 border-l-2 border-border pl-8 md:ml-4 md:pl-6">
          ...
          <BlurFade delay={STAGGER_DELAY} inView className="relative mb-10">
            ...
            <div
              className={cn(
                'rounded-lg border border-border bg-muted p-6 text-center transition-colors duration-200 hover:border-primary',
            ...
            >
              ...
              {isWaitingForFirstQuiz && !upload.uploadedUrl ? (
                ...
                <>
                  <div className="mb-4 md:mb-3">
                    <FileText className="size-12 md:size-10 text-muted-foreground" />
                  </div>
          ...
          {upload.uploadedUrl && !generation.problemSetId && (
            <>
              ...
              <BlurFade delay={STAGGER_DELAY * 2} inView className="relative mb-10">
                ...
                <div className="rounded-lg border border-border bg-muted p-6 transition-colors duration-200 hover:border-primary">
                  <div className="my-4 flex overflow-hidden rounded-lg bg-muted">
                    {quizTypes.map((type) => (
                      <button
                        key={type.key}
                        className={cn(
                  ...
                  <div className="flex items-start gap-4 md:flex-col md:items-stretch md:gap-2">
                    ...
                    <div className="mb-4 w-full text-center">
                      <div className="w-full max-w-full rounded-[10px] border border-border bg-background p-3 shadow-sm md:p-3.5">
              ...
              <BlurFade delay={STAGGER_DELAY * 4} inView className="relative mb-10">
                ...
                <div className="rounded-lg border border-border bg-muted p-6 transition-colors duration-200 hover:border-primary">
                  <div className="flex flex-col items-start gap-3 md:flex-col md:items-stretch md:gap-2">
                    <div className="flex items-center gap-1.5 pb-1.5 text-sm font-medium text-foreground">
                    ...
                    <div className="flex w-full flex-wrap items-center gap-3 rounded-lg border border-border bg-background p-4 text-center md:flex-col md:items-stretch md:p-3">
              ...
              <BlurFade delay={STAGGER_DELAY * 5} inView className="relative mb-10">
                ...
                <div className="rounded-lg border border-border bg-muted p-6 transition-colors duration-200 hover:border-primary">
                  <div className="flex min-h-[150px] items-center justify-center rounded-lg border border-border bg-background p-5 text-center md:min-h-[100px] md:p-4">
          ...
          {generation.problemSetId && (
            <BlurFade delay={STAGGER_DELAY} inView className="relative mb-10">
              ...
              <div className="rounded-lg border border-border bg-muted p-6 transition-colors duration-200 hover:border-primary">
                <div className="flex w-full flex-wrap items-center gap-6 rounded-lg bg-background p-6 shadow-sm transition-shadow duration-200 hover:shadow-md md:flex-col md:items-start md:gap-2 md:p-4">
