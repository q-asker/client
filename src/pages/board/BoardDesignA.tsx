...
/** Card List — Shadcn Card/Badge/Button 기반 카드 리스트 레이아웃 */
const BoardDesignA = () => {
                  ...
                  return (
                    ...
                    >
                      <CardContent className="flex items-center gap-4 py-4 max-md:flex-col max-md:items-start">
                        {/* 번호 */}
                        <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-muted text-sm font-bold text-muted-foreground max-md:hidden">
                          {virtualNumber}
                        </div>
