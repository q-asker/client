...
import type { MockQuizHistoryRecord, MockQuizStats } from './mockHistoryData';
import {
  FileText,
  Trophy,
  CheckCircle,
...
/** Card Gallery — Shadcn Card/Badge/Button 기반 카드 갤러리 레이아웃 */
const QuizHistoryDesignA = () => {
...
export default QuizHistoryDesignA;
