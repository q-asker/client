...
/** DesignB — 풀스크린 muted 배경 + 대형 아이콘 + animate-pulse 진행 바 (MagicUI 미사용) */
const MaintenanceDesignB = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-muted p-8 text-center">
      ...
      <div className="mb-8 w-full max-w-xs">
        ...
        <p className="mt-2 text-xs text-muted-foreground">{t('점검이 진행 중입니다...')}</p>
      </div>
...
export default MaintenanceDesignB;
